...
export class ListEndPointsService {
  ...
  getEndPoint = {
    ...
    endPointCRUDActividades: {
      ...
      }, // Modulo de Financiamiento de Proyectos | Desembolsos
      newActividadFinanciamientoDetDesembolso: {
        id: 70.204,
        nameEndpoint: 'newActividadFinanciamientoDetDesembolso',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-desembolso/new',
        params: '{ jsonSendActividadFinanciamientoDetDesembolso }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Ingresar el dato de Detalle de Financiamiento Desembolso enviado y asociarlo al Proyecto',
      },
      deleteActividadFinanciamientoDetDesembolso: {
        id: 70.205,
        nameEndpoint: 'deleteActividadFinanciamientoDetDesembolso',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-desembolso/delete/',
        params: '{ codigoFinancDesembolso }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Eliminar el dato de Detalle de Financiamiento Desembolso enviado y asociarlo al Proyecto',
      },
      findByIdActividadDetDesembolsos: {
        id: 70.206,
        nameEndpoint: 'findByIdActividadDetDesembolsos',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-desembolso/findByIdActividadDet/',
        params: '{ idActividadDet }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Listar todos los Desembolsos del Proyecto',
      },
      editActividadFinanciamientoDetDesembolso: {
        id: 70.207,
        nameEndpoint: 'editActividadFinanciamientoDetDesembolso',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-desembolso/edit/',
        params: '{ idActividadFinancDetDesembolso }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Actualizar Información de Desembolso del Proyecto',
      }, // Modulo de Financiamiento de Proyectos | Gastos
      newActividadFinanciamientoDetGasto: {
        id: 70.208,
        nameEndpoint: 'newActividadFinanciamientoDetGasto',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-gasto/new',
        params: '{ jsonSendActividadFinanciamientoDetGasto }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Ingresar el dato de Detalle de Financiamiento Gasto enviado y asociarlo al Proyecto',
      },
      deleteActividadFinanciamientoDetGasto: {
        id: 70.209,
        nameEndpoint: 'deleteActividadFinanciamientoDetGasto',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-gasto/delete/',
        params: '{ codigoFinancGasto }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Eliminar el dato de Detalle de Financiamiento Gasto enviado y asociarlo al Proyecto',
      },
      findByIdActividadDetGastos: {
        id: 70.210,
        nameEndpoint: 'findByIdActividadDetGastos',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-gasto/findByIdActividadDet/',
        params: '{ idActividadDet }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Listar todos los Gastos del Proyecto',
      },
      editActividadFinanciamientoDetGasto: {
        id: 70.211,
        nameEndpoint: 'editActividadFinanciamientoDetGasto',
        urlEndPoint: '/mant-actividades/financiamiento/detalle-gasto/edit/',
        params: '{ idActividadFinancDetGasto }',
        groupEndPoint: 'actividadesCRUDGroup',
        descEndPoint: 'Actualizar Información de Gasto del Proyecto',
      },
