...
export class GrupoTrabajoService {
    ...
    ****************************************************************************/
    ...
    /****************************************************************************
       * Funcion: FND-00003
       * Fecha: 21-01-2019
       * Descripcion: Metodo que sirve para poder ingresar un nuevo tipo de organizacion
       * Params: { jsonPerfil }
       ****************************************************************************/
    newTipoOrganizacion(jsonPerfil): Observable<any> {
        // Parametros del EndPoint
        const paramsSend = jsonPerfil;
        // Retorno de la Funcion
        return this._http.post(this._systemEndPointsService.getEndPointService('organizacionesGroup', 3), paramsSend, {
            headers: this.headers,
            params: { 'tokenApi': this.tokenHeader },
        });
    }// FIN | FND-00003
    ...
    ****************************************************************************/
    tipoOganizacionUpdate(jsonTipoOrganizacio, idTipoOrganizacion: number): Observable<any> {
        // Parametros del EndPoint
        const paramsSend = jsonTipoOrganizacio;
        const idTipoOrg: number = idTipoOrganizacion;
        // Retorno de la Funcion
        return this._http.put(this._systemEndPointsService.getEndPointService('organizacionesGroup', 12) + idTipoOrg, paramsSend, {
            headers: this.headers,
            params: { 'tokenApi': this.tokenHeader },
        });
    }// FIN | FND-00004
    ...
    /****************************************************************************
      ...
      ****************************************************************************/
    organizacionTipodelete(idTipoOrganizacion: number): Observable<any> {
        // Parametros del EndPoint
        const idTipoOrg: number = idTipoOrganizacion;
        // Retorno de la Funcion
        return this._http.delete(this._systemEndPointsService.getEndPointService('organizacionesGroup', 13) + idTipoOrg, {
            headers: this.headers,
            params: { 'tokenApi': this.tokenHeader },
        });
    }// FIN | FND-00005
